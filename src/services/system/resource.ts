...
export async function listResource(params: API.Params, options?: { [key: string]: any }) {
...
export async function addResource(body: API.Resource, options?: { [key: string]: any }) {
  return request<API.Result<API.Resource>>("/api/v1/sys/resources", {
    method: "POST",
    data: body,
    ...(options || {}),
...
export async function getResource(id: string, options?: { [key: string]: any }) {
...
export async function updateResource(id: string, body: API.Resource, options?: { [key: string]: any }) {
...
export async function deleteResource(id: string, options?: { [key: string]: any }) {
  return request<API.Result<any>>(`/api/v1/sys/resources/${id}`, {
    method: "DELETE",
    ...(options || {}),
  });
