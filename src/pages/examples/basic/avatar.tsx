...
import StatusAvatar, { RingWidth, Size, StatusPosition, StatusType } from "@/components/StatusAvatar";
    ...
    <div className='space-y-8 p-6'>
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Demonstrates different statuses on a standard image avatar with new shape support and smart badge
            adaptation.
          </CardDescription>
        </CardHeader>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Demonstrates using an icon as the main avatar content, with synchronized borders and smart shape adaptation.
          </CardDescription>
        </CardHeader>
        <CardContent className='space-y-6'>
          <div className='flex flex-wrap items-end gap-8'>
            <StatusAvatar
              ...
              shape={shape}
              status='online'
              statusBorderStyle={{ width: ringWidth, color: ringColor }}
              statusPosition={position}
            >
            ...
            <StatusAvatar
              ...
              statusPosition={position}
            >
              <Star className='h-full w-full text-blue-500' />
            </StatusAvatar>
          </div>
        </CardContent>
      </Card>
      ...
      <Card className='max-w-lg'>
        <CardHeader>
          ...
          <CardDescription>
            Dynamically change the properties of the avatars above. Test new features including shape support and smart
            badge adaptation.
          </CardDescription>
        </CardHeader>
        <CardContent className='space-y-4'>
          <div className='space-y-2'>
            ...
            <Tabs
              value={shape}
              onValueChange={(value) => setShape(value as "circle" | "square" | "rounded-square")}
              className='w-full'
            >
            ...
            <div className='flex gap-4'>
              <div className='flex items-center w-full'>
                ...
                <button
                  ...
                  onClick={() => handleOffsetChange(setStatusOffsetX, -5)}
                >
                  -
                </button>
                <input
                  type='text'
                  value={statusOffsetX}
                  onChange={(e) => setStatusOffsetX(e.target.value)}
                  className='border-t border-b p-2 w-full text-center'
              ...
              <div className='flex items-center w-full'>
                ...
                <button
                  className='p-2 border rounded-l-md hover:bg-gray-100'
                  onClick={() => handleOffsetChange(setStatusOffsetY, -5)}
                >
                  -
                </button>
                <input
                  type='text'
                  value={statusOffsetY}
                  onChange={(e) => setStatusOffsetY(e.target.value)}
                  className='border-t border-b p-2 w-full text-center'
                  placeholder='e.g., -10px'
                />
                <button
